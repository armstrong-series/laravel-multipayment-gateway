    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#advanced" aria-expanded="false" aria-controls="advanced">
                ...
                <span class="menu-title">Integrations &nbsp;<i class="fas fa-microchip"></i></span>

            </a>
            <div class="collapse" id="advanced">
                <ul class="nav flex-column sub-menu">

                    <li class="nav-item {{ $page == 'payment-integration' ? 'active' : '' }}""> <a class="nav-link" href="{{ route('user.integrations.payment') }}">Payment &nbsp;<i class="fas fa-wallet"></i></a></li>
